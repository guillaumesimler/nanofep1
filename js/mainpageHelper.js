...
var HTMLmainImage = '<picture><source media="(min-width: 400px)" srcset="images/%data%-600_2x.jpg 2x, images/%data%-600_1x.jpg 1x"><source media="(max-width: 399px)" srcset="images/%data%-400_2x.jpg 2x, images/%data%-400_1x.jpg 1x"><img íd="mainImage%index%" class="img-responsive center-block" src="images/%data%-400_1x.jpg" data-toggle="modal" data-target="#project%index%"></picture>';
